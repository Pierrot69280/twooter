...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: Twoote::class, mappedBy: 'author', orphanRemoval: true)]
    private Collection $twootes;
    ...
    {
        $this->twootes = new ArrayCollection();
     ...
     */
    public function getTwootes(): Collection
    {
        return $this->twootes;
    }
    ...
    {
        if (!$this->twootes->contains($twoote)) {
            $this->twootes->add($twoote);
            $twoote->setAuthor($this);
        }
    ...
    {
        if ($this->twootes->removeElement($twoote)) {
            // set the owning side to null (unless already changed)
            if ($twoote->getAuthor() === $this) {
                $twoote->setAuthor(null);
            }
        }
